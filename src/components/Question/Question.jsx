...
export default function Question({
  ...
  return (
    <div className={styles.AllComponent}>
              ...
              <div className={styles.checkbox}>
                <div style={{ width: '15px', height: '15px' }}>
                  {selectedCategory === category ? (
                    ...
                    >
                      <path
                        d="M12.75 0H2.25C1.65326 0 1.08097 0.237053 0.65901 0.65901C0.237053 1.08097 0 1.65326 0 2.25V12.75C0 13.3467 0.237053 13.919 0.65901 14.341C1.08097 14.7629 1.65326 15 2.25 15H12.75C13.3467 15 13.919 14.7629 14.341 14.341C14.7629 13.919 15 13.3467 15 12.75V2.25C15 1.65326 14.7629 1.08097 14.341 0.65901C13.919 0.237053 13.3467 0 12.75 0Z"
                        fill="#C9C9C9"
                      />
                    </svg>
                  )}
      ...
      {/* Button and Status Section for Desktop */}
      ...
      {/* Button and Status Section for Mobile */}
      <div className={styles.mobileButtonStatusContainer}>
        <StatusBar
          currentQuestion={currentQuestion}
          totalQuestions={totalQuestions}
        />
