...
import React, { useState, useEffect } from "react";
  ...
  const resultDetails = {
    0: {
      title: "Ноль это не предел!",
      text: "Не бойтесь неудач! Они помогают нам понять наши слабые стороны и работать над собой. В nFactorial School мы предлагаем интенсивную подготовку к SAT с групповыми занятиями и персональным ИИ-тренером, чтобы помочь вам поступить в университет мечты. Дарим вам бесплатную консультацию от экспертов, где расскажем, что нужно для идеального результата! Наши менеджеры свяжутся с вами в ближайшее время :)",
      images: {
    ...
    4: {
      ...
      text: "Выше среднего! Вы хорошо подготовились, но есть ещё области, требующие внимания. Сосредоточьтесь на более сложных задачах для улучшения результата. nFactorial School поможет вам благодаря интенсивной подготовке к SAT, включая групповые занятия и поддержку ИИ-тренера, чтобы вы поступили в ваш университет мечты. Дарим вам бесплатную консультацию от экспертов, где расскажем, что нужно для идеального результата! Наши менеджеры свяжутся с вами в ближайшее время  :)",
      images: {
        desktop: "/images/results/desktop/data_analytics.webp",
        mobile: "/images/results/desktop/data_analytics.webp",
      },
