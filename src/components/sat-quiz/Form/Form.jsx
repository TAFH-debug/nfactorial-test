    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.dataLayer) {
        window.dataLayer.push({
          event: 'form_submit',
          formName: 'quiz_form_sat',
          ...attributionData
        });
      }
      sendGAEvent('form_submission', { form_type: 'sat-quiz', ...attributionData });
      if (typeof posthog !== 'undefined') {
        posthog.capture('form_submitted', { form_name: 'quiz_form_sat', ...attributionData });
      }
      if (typeof fbq !== 'undefined') {
        fbq('track', 'Lead', { content_name: 'quiz_form_sat', ...attributionData });
      }
      ...
      if (response.ok) {
        if (typeof window !== 'undefined' && window.dataLayer) {
          window.dataLayer.push({ event: 'form_success', formName: 'quiz_form_sat' });
        }
        if (typeof posthog !== 'undefined') {
          posthog.capture('form_success', { form_name: 'quiz_form_sat' });
        }
      ...
      if (typeof posthog !== 'undefined') {
        posthog.capture('form_error', { form_name: 'quiz_form_sat', error: error.message });
      }
    } finally {
      setSubmitting(false);
    }
