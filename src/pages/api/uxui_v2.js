    ...
    const questions = [
      {
        ...
        feedback: {
          correct:
            "Верно! Во втором варианте межбуквенные и межстрочные отступы слишком большие.",
          incorrect:
      ...
      },
      {
        ...
        feedback: {
          correct:
          "Верно! Лучше избегать чистого черного цвета, так как он очень контрастный и может вызывать  напряжение глаз и усталость.",
          incorrect:
      ...
      },
      {
        ...
        feedback: {
          correct:
            "У вас глаз-алмаз! Вы заметили разницу в размере диалогового облака. ",
          incorrect:
